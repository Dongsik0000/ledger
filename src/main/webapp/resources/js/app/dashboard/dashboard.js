App.dashboard = (function(){
    var LAST_PAYMENT_KEY = 'ledger.lastPaymentMethodId',
        ...
        renderSummary = function(s){
            ...
            m$.cycleIncome.textContent = '+' + App.money(s.cycleIncome);
            m$.cycleExpense.textContent = '−' + App.money(s.cycleExpense);
            ...
            App.post(url.recent)
                .then(function(res){
                    App.result(res, {ok: function(){
                        ...
                        m$.recent.replaceChildren.apply(m$.recent, App.entryForm.grouped(res.data, null));
                    }});
                })
                .catch(function(){});
        },
